...
class PaymentBDVO:
    def __init__(self, direction: str, creator_system: str = None):
        ...
        creator_system = creator_system.lower() if creator_system else None
        
        
        self.validation_input_data(direction=direction)
    ...
    def create_account(self, 
                       ...
                       isTransint: bool = False, 
                       account_lenght: int = 20, 
                       currency_code: str = '810', 
                       isClientAccount: bool = True
                       ):
        start_account_list = []
        if isResident:
